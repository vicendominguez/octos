...
func TestRunAgentWithStdin(t *testing.T) {
	...
	output, err := runAgent(context.Background(), agent, "hello from stdin", nil, 0)
	if err != nil {
...
func TestRunAgentWithoutStdin(t *testing.T) {
	...
	output, err := runAgent(context.Background(), agent, "the prompt", nil, 0)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestStdinWithLargePrompt(t *testing.T) {
	...
	output, err := runAgent(context.Background(), agent, largePrompt, nil, 0)
	if err != nil {
